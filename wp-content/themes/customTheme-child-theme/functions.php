 ...
 */
function orbisius_ct_customtheme_child_theme_child_theme_enqueue_styles() {
	global $wp_styles;

    $parent_style = 'orbisius_ct_customtheme_child_theme_parent_style';
    $parent_base_dir = 'customTheme';
...
add_action( 'wp_enqueue_scripts', 'orbisius_ct_customtheme_child_theme_child_theme_enqueue_styles', 25 );
