<?php wp_footer(); ?>
	...
	<footer>
		<div class="container">
			<div class="footerGrid">
				...
				<div class="footerCol">
					<h3 class="footertitle">Ubezpieczenia</h3>
					<div class="footerLinks">
				...
				<div class="footerCol">
					<h3 class="footertitle">Infolinia</h3>
					<div class="footerLinks">
						<a class="phoneNumber" href="tel:">+48 22 311 1234</a>
					</div>
				</div>
	...
	<script src="wp-content/themes/customTheme-child-theme/js/custom.js"></script>
</body>
</html>